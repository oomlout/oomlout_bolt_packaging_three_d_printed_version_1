...
difference() {
	union() {
		...
		translate(v = [15.0000000000, -90, -12.5000000000]) {
			hull() {
		...
		translate(v = [5.0000000000, -87.5000000000, -12.5000000000]) {
			cube(size = [20, 5, 17]);
		}
		translate(v = [-15.0000000000, -90, -12.5000000000]) {
			hull() {
		...
		translate(v = [-25.0000000000, -87.5000000000, -12.5000000000]) {
			cube(size = [20, 5, 17]);
		}
	}
	union() {
		...
		translate(v = [25.0000000000, -90, 0]) {
			rotate(a = [0, 90, 0]) {
				difference() {
					union() {
		...
		translate(v = [9.5000000000, -100.2500000000, -12.5000000000]) {
			cube(size = [11, 17.5000000000, 20]);
		}
		translate(v = [-20.5000000000, -100.2500000000, -12.5000000000]) {
			cube(size = [11, 17.5000000000, 20]);
		}
	}
}