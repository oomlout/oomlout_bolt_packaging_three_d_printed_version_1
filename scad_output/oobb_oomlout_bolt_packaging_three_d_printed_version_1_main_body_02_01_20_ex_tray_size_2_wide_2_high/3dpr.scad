...
difference() {
	union() {
		...
		translate(v = [10.2500000000, -15.0000000000, 5.0000000000]) {
			cube(size = [20, 22.5000000000, 11]);
		}
		translate(v = [10.2500000000, -13.5000000000, 5.0000000000]) {
		...
		translate(v = [-30.2500000000, -15.0000000000, 5.0000000000]) {
			cube(size = [20, 22.5000000000, 11]);
		}
		translate(v = [-30.2500000000, -13.5000000000, 5.0000000000]) {
			cube(size = [20, 27, 7.5000000000]);
		}
		translate(v = [0, -37.5000000000, -5.0000000000]) {
			hull() {
		...
		translate(v = [-10.0000000000, -35.0000000000, -5.0000000000]) {
			cube(size = [20, 5, 17]);
		}
	}
	union() {
		...
		translate(v = [10.0000000000, -37.5000000000, 7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				difference() {
					union() {
		...
		translate(v = [14.7500000000, 0.2500000000, 5.0000000000]) {
			cube(size = [11, 17.5000000000, 15]);
		}
		translate(v = [-25.7500000000, 0.2500000000, 5.0000000000]) {
			cube(size = [11, 17.5000000000, 15]);
		}
		translate(v = [-5.5000000000, -47.7500000000, -5.0000000000]) {
