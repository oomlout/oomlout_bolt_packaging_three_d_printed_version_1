...
difference() {
	union() {
		...
		translate(v = [22.5000000000, -90, -12.5000000000]) {
			hull() {
		...
		translate(v = [12.5000000000, -87.5000000000, -12.5000000000]) {
			cube(size = [20, 5, 17]);
		}
		translate(v = [-22.5000000000, -90, -12.5000000000]) {
			hull() {
		...
		translate(v = [-32.5000000000, -87.5000000000, -12.5000000000]) {
			cube(size = [20, 5, 17]);
		}
	}
	union() {
		...
		translate(v = [32.5000000000, -90, 0]) {
			rotate(a = [0, 90, 0]) {
				difference() {
					union() {
		...
		translate(v = [-12.5000000000, -90, 0]) {
			rotate(a = [0, 90, 0]) {
				difference() {
					union() {
						translate(v = [0, 0, -22.0000000000]) {
		...
		translate(v = [17.0000000000, -100.2500000000, -12.5000000000]) {
			cube(size = [11, 17.5000000000, 20]);
		}
		translate(v = [-28.0000000000, -100.2500000000, -12.5000000000]) {
			cube(size = [11, 17.5000000000, 20]);
		}
	}
}