...
difference() {
	union() {
		...
		translate(v = [-0.7500000000, -15.0000000000, 1.0000000000]) {
	...
	union() {
		...
		translate(v = [4.5000000000, 0.0000000000, 0.5000000000]) {
		...
		translate(v = [-10.0000000000, 0.0000000000, 0.5000000000]) {
			cube(size = [5.5000000000, 15, 15]);
		}
