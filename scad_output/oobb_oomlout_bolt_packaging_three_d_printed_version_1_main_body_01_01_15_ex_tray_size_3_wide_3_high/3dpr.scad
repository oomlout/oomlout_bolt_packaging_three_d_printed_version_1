...
difference() {
	union() {
		...
		translate(v = [6.7500000000, 7.5000000000, 7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 16, r = 6.0000000000);
			}
		}
		translate(v = [6.7500000000, -15.0000000000, 1.5000000000]) {
			cube(size = [16, 22.5000000000, 12]);
		}
		translate(v = [6.7500000000, -13.5000000000, 0.0000000000]) {
		...
		translate(v = [-22.7500000000, -15.0000000000, 1.5000000000]) {
			cube(size = [16, 22.5000000000, 12]);
		}
	...
	union() {
		...
		translate(v = [12.0000000000, 0.2500000000, 0.0000000000]) {
		...
		translate(v = [-17.5000000000, 0.2500000000, 0.0000000000]) {
			cube(size = [5.5000000000, 14.5000000000, 15]);
		}
