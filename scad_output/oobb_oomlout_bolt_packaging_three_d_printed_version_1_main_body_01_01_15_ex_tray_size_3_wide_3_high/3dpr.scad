...
difference() {
	union() {
		...
		translate(v = [22.5000000000, -45, -7.5000000000]) {
			hull() {
		...
		translate(v = [12.5000000000, -42.5000000000, -7.5000000000]) {
			cube(size = [20, 5, 12]);
		}
		translate(v = [-22.5000000000, -45, -7.5000000000]) {
			hull() {
		...
		translate(v = [-32.5000000000, -42.5000000000, -7.5000000000]) {
			cube(size = [20, 5, 12]);
		}
	}
	union() {
		...
		translate(v = [17.0000000000, -55.2500000000, -7.5000000000]) {
			cube(size = [11, 17.5000000000, 15]);
		}
		translate(v = [-28.0000000000, -55.2500000000, -7.5000000000]) {
			cube(size = [11, 17.5000000000, 15]);
		}
	}
}