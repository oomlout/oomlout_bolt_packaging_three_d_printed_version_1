...
difference() {
	union() {
		...
		translate(v = [29.2500000000, -15.0000000000, 1.0000000000]) {
		...
		translate(v = [-45.2500000000, -15.0000000000, 1.0000000000]) {
			cube(size = [16, 22.5000000000, 14]);
		}
	...
	union() {
		...
		translate(v = [34.5000000000, 0.0000000000, 0.5000000000]) {
		...
		translate(v = [-40.0000000000, 0.0000000000, 0.5000000000]) {
			cube(size = [5.5000000000, 15, 15]);
		}
