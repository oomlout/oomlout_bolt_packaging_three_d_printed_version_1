...
difference() {
	union() {
		...
		translate(v = [51.7500000000, 7.5000000000, 7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 16, r = 6.0000000000);
			}
		}
		translate(v = [51.7500000000, -15.0000000000, 1.5000000000]) {
			cube(size = [16, 22.5000000000, 12]);
		}
		translate(v = [51.7500000000, -13.5000000000, 0.0000000000]) {
		...
		translate(v = [-67.7500000000, -15.0000000000, 1.5000000000]) {
			cube(size = [16, 22.5000000000, 12]);
		}
	...
	union() {
		...
		translate(v = [56.7500000000, 0.2500000000, 0.0000000000]) {
		...
		translate(v = [-62.7500000000, 0.2500000000, 0.0000000000]) {
			cube(size = [6, 14.5000000000, 15]);
		}
