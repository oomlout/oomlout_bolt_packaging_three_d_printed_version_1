...
difference() {
	union() {
		...
		translate(v = [10.0000000000, -82.5000000000, -7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 10, r = 7.0000000000);
			}
		}
		translate(v = [10.0000000000, -89.5000000000, -7.5000000000]) {
			cube(size = [10, 14, 7.5000000000]);
		}
		translate(v = [10.0000000000, -90.0000000000, 0.0000000000]) {
			cube(size = [10, 14.5000000000, 1]);
		}
		translate(v = [-20.0000000000, -82.5000000000, -7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 10, r = 7.0000000000);
			}
		}
		translate(v = [-20.0000000000, -89.5000000000, -7.5000000000]) {
			cube(size = [10, 14, 7.5000000000]);
		}
		translate(v = [-20.0000000000, -90.0000000000, 0.0000000000]) {
			cube(size = [10, 14.5000000000, 1]);
		}
	}
	union() {
