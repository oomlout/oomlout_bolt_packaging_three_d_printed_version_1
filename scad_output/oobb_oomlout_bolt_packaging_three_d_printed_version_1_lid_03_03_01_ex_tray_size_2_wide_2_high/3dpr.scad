...
difference() {
	union() {
		translate(v = [0, -45.0000000000, -3]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
						hull() {
							translate(v = [-41.7333333333, 41.7333333333, 0]) {
		...
		translate(v = [15.0000000000, -93.0000000000, -3]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
						hull() {
		...
		translate(v = [15.0000000000, -93.0000000000, 0]) {
			hull() {
				translate(v = [-5.5000000000, -0.5000000000, 0]) {
					cylinder(h = 1, r = 2);
				}
	...
	union() {
		...
		translate(v = [9.0000000000, -93.0000000000, -10]) {
			cube(size = [12, 3, 10]);
		}
		translate(v = [-15.0000000000, -90, -100.0000000000]) {
			cylinder(h = 200, r = 1.8000000000);
		}
		translate(v = [-21.0000000000, -93.0000000000, -10]) {
			cube(size = [12, 3, 10]);
		}
	}
}