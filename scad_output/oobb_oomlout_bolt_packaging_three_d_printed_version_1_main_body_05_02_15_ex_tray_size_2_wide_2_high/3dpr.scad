...
difference() {
	union() {
		...
		translate(v = [59.2500000000, 7.5000000000, 7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 16, r = 6.0000000000);
			}
		}
		translate(v = [59.2500000000, -15.0000000000, 1.5000000000]) {
			cube(size = [16, 22.5000000000, 12]);
		}
		translate(v = [59.2500000000, -13.5000000000, 0.0000000000]) {
		...
		translate(v = [-75.2500000000, -15.0000000000, 1.5000000000]) {
			cube(size = [16, 22.5000000000, 12]);
		}
	...
	union() {
		...
		translate(v = [64.2500000000, 0.2500000000, 0.0000000000]) {
			cube(size = [6, 14.5000000000, 15]);
		}
		translate(v = [59.7500000000, 7.5000000000, 7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 15, r = 1.8000000000);
			}
		}
		translate(v = [-70.2500000000, 0.2500000000, 0.0000000000]) {
			cube(size = [6, 14.5000000000, 15]);
		}
		translate(v = [-74.7500000000, 7.5000000000, 7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 15, r = 1.8000000000);
			}
		}
