...
difference() {
	union() {
		...
		translate(v = [15.0000000000, -60, -7.5000000000]) {
			hull() {
		...
		translate(v = [5.0000000000, -57.5000000000, -7.5000000000]) {
			cube(size = [20, 5, 12]);
		}
		translate(v = [-15.0000000000, -60, -7.5000000000]) {
			hull() {
		...
		translate(v = [-25.0000000000, -57.5000000000, -7.5000000000]) {
			cube(size = [20, 5, 12]);
		}
	}
	union() {
		...
		translate(v = [9.5000000000, -70.2500000000, -7.5000000000]) {
			cube(size = [11, 17.5000000000, 15]);
		}
		translate(v = [-20.5000000000, -70.2500000000, -7.5000000000]) {
			cube(size = [11, 17.5000000000, 15]);
		}
	}
}