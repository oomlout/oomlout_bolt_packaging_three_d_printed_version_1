...
difference() {
	union() {
		...
		translate(v = [-10.0000000000, -37.5000000000, 0.0000000000]) {
			cube(size = [20, 7.5000000000, 11]);
		}
		translate(v = [-10.0000000000, -41.2500000000, 0.0000000000]) {
			cube(size = [20, 12, 7.5000000000]);
		}
	}
	union() {
		translate(v = [30.2500000000, 7.5000000000, 7.5000000000]) {
