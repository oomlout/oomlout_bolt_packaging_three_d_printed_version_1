...
difference() {
	...
	union() {
		...
		#translate(v = [10.2500000000, 1.5000000000, 12.0000000000]) {
			rotate(a = [22.5000000000, 0, 0]) {
				cube(size = [20, 12, 6]);
			}
		}
		#translate(v = [10.2500000000, 0.2500000000, 12.0000000000]) {
			cube(size = [20, 3, 6]);
		}
		translate(v = [-25.7500000000, 0.2500000000, 0.0000000000]) {
			cube(size = [11, 17.5000000000, 15]);
		}
		#translate(v = [-30.2500000000, 1.5000000000, 12.0000000000]) {
			rotate(a = [22.5000000000, 0, 0]) {
				cube(size = [20, 12, 6]);
			}
		}
		#translate(v = [-30.2500000000, 0.2500000000, 12.0000000000]) {
			cube(size = [20, 3, 6]);
		}
