...
difference() {
	union() {
		...
		translate(v = [15.2500000000, -15.0000000000, 0.5000000000]) {
		...
		translate(v = [-30.2500000000, -15.0000000000, 0.5000000000]) {
			cube(size = [15, 22.5000000000, 14]);
		}
	}
	union() {
		...
		translate(v = [20.0000000000, 0.0000000000, 0.0000000000]) {
		...
		translate(v = [-25.5000000000, 0.0000000000, 0.0000000000]) {
			cube(size = [5.5000000000, 15, 15]);
		}
		translate(v = [-30.2500000000, 7.5000000000, 7.5000000000]) {
			rotate(a = [0, 90, 0]) {
