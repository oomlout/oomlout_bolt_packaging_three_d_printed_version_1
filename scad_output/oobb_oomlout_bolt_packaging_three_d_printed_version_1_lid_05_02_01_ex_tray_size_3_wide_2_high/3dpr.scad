...
difference() {
	union() {
		translate(v = [0, -30.0000000000, -3]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
						hull() {
							translate(v = [-109.2333333333, 26.7333333333, 0]) {
		...
		translate(v = [22.5000000000, -63.0000000000, -3]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
						hull() {
		...
		translate(v = [22.5000000000, -63.0000000000, 0]) {
			hull() {
				translate(v = [-5.5000000000, -0.5000000000, 0]) {
					cylinder(h = 1, r = 2);
				}
	...
	union() {
		...
		translate(v = [16.5000000000, -63.0000000000, -10]) {
			cube(size = [12, 3, 10]);
		}
		translate(v = [-22.5000000000, -60, -100.0000000000]) {
			cylinder(h = 200, r = 1.8000000000);
		}
		translate(v = [-28.5000000000, -63.0000000000, -10]) {
			cube(size = [12, 3, 10]);
		}
	}
}